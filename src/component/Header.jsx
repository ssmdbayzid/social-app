...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
      ...
      <Link to={"/home"} className="block py-2 pl-3 pr-4 text-white hover:text-blue-500" aria-current="page">Home</Link>
      <Link to={"/media"} className="block py-2 pl-3 pr-4 text-white hover:text-blue-500" aria-current="page">Media</Link>
      <Link to={"/home"} className="block py-2 pl-3 pr-4 text-white hover:text-blue-500" aria-current="page">Message</Link>
      <Link to={"/about"} className="block py-2 pl-3 pr-4 text-white hover:text-blue-500" aria-current="page">About</Link>
      {!user && <Link to={"/login"} className="block py-2 pl-3 pr-4 text-white hover:text-blue-500" aria-current="page">Login</Link>}
      {!user && <Link to={"/signup"} className="block py-2 pl-3 pr-4 text-white hover:text-blue-500" aria-current="page">Signup</Link>}
